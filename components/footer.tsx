import { Facebook, Github, InstagramIcon, LinkedinIcon, TwitterIcon } from "lucide-react";
                ...
                <div className="flex flex-col md:flex-row items-start justify-between relative p-8 md:p-12 overflow-hidden pb-32 md:pb-42 bg-linear-to-t from-orange-50 to-orange-100 rounded-t-2xl">
                    ...
                    <div>
                        ...
                        <AnimatedContent className="flex flex-col mt-6 gap-3">
                            <a href="https://www.facebook.com/jishanhoshen.jibon" className="flex items-center gap-2 text-orange-500">
                                <Facebook size={20} />
                                <p>Facebook</p>
                            </a>
                            <a href="https://github.com/jishanhoshen" className="flex items-center gap-2 text-orange-500">
                                <Github size={20} />
                                <p>GitHub</p>
                            </a>
                            <a href="https://www.instagram.com/jishanhoshen.jibon" className="flex items-center gap-2 text-orange-500">
