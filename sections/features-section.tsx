                ...
                <div>
                    <div className="p-4 pt-16 md:p-16 flex flex-col items-start md:sticky md:top-26">
                        <SectionTitle
                            ...
                            icon={SparkleIcon}
                            title="Core features"
                            subtitle="Everything you need to build modern, scalable, and user-friendly web applications — designed for speed, reliability, and real-world business needs."
                        />
                        <AnimatedContent className="p-4 md:p-6 bg-orange-500 w-full rounded-xl mt-12">
                            <p className="text-lg text-white">
                                Trusted by clients and teams looking for high-quality web solutions.
                            </p>
